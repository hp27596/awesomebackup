...
rsync -Pra --delete ~/.config/{awesome,misc,alacritty,bottom,btop,cmus,dunst,fcitx5,feh,'gtk-2.0','gtk-3.0',mpv,nvim,picom,ranger,rofi,dmenu-frecency,zathura} $HOME/awesomebackup/.config
